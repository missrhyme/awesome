...
window.pageInit = function (_ref) {
  var _ref$list = _ref.list,
      ...
      pageType = _ref$pageType === undefined ? 'mail' : _ref$pageType;
  return new _vue2.default({
    ...
    methods: {
      ...
      handleSubmit: function handleSubmit() {
        ...
        var url = this.isEdit ? '/api/' + pageType + 'Template/edit' : '/api/' + pageType + 'Template/add';
        (0, _fetch2.default)({
          url: url,
          type: 'POST',
          data: this.form
